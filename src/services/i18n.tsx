...
export const translations: Translations = {
  ...
  updatePortfolioDesc: { 'zh-TW': '上傳資產截圖或交易確認單以同步數據。(一次最多 4 張)', 'zh-CN': '上传资产截图或交易确认单以同步数据。(一次最多 4 张)', 'en': 'Upload screenshots or trade confirmations to sync. (Up to 4 images)' },
  analyzingImage: { 'zh-TW': '正在分析圖片...', 'zh-CN': '正在分析图片...', 'en': 'Analyzing image...' },
  analyzingProgress: { 'zh-TW': '正在分析第 {current} / {total} 張圖片...', 'zh-CN': '正在分析第 {current} / {total} 张图片...', 'en': 'Analyzing image {current} of {total}...' },
